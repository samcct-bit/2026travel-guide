...
export const itineraryData: DailyItinerary[] = [
  {
    ...
    flow: [
      ...
      },
      {
        ...
        notes: '今日乾潮 12:47 (潮位 1cm)，14:20 剛過乾潮，幻之沙灘大片裸露，最適合拍攝！',
        details: '跑道盡頭的碧海與白沙。由於出發當日乾潮時間為 12:47，14:20 抵達時沙灘仍會大片露出，可安全踩踏在雪白沙洲上。'
      },
      {
        time: '15:15',
  ...
  },
  {
    ...
    flow: [
      ...
      },
      {
        ...
        notes: '今日乾潮 14:15 (潮位 3cm)，12:00 處於退潮期，沙灘寬廣開闊最宜野餐踩浪。',
        details: '擁有極寬廣的細白沙灘。由於今日乾潮時間為 14:15，中午抵達時正值退潮，沙灘面積最大且最為平緩開闊，非常適合野餐。'
      },
      {
        time: '13:00',
        title: '穿越來間大橋，前往來間島',
  ...
  },
  {
    ...
    flow: [
      ...
      },
      {
        ...
        type: 'activity',
        notes: '今日乾潮 14:58 (10cm)。出海退潮時段，八重干瀨珊瑚礁接近水面，景致最美且水流平緩。',
        details: '今日滿潮 08:13，乾潮 14:58。出海時間正值退潮，抵達八重干瀨時，珊瑚礁頂會非常接近水面，能觀賞到最震撼的珊瑚花園。'
      },
      {
        time: '14:00',
  ...
  },
  {
    ...
    flow: [
      ...
      },
      {
        ...
        notes: '今日滿潮 09:01。漲潮時段海龜會游進岸邊淺水區覓食，最適合站在岸上尋龜！',
        details: '早上 06:50 正值漲潮推進期。此時海龜會游進靠岸的淺水區覓食海草。水面平靜，是站在岸上觀賞海龜探頭呼吸的黃金時刻。'
      },
      {
        time: '08:30',
        title: '南部沿海悠閒早餐與短暫歇息',
      ...
      },
      {
        ...
        type: 'activity',
        notes: '今日滿潮 09:01，乾潮 15:38。此時水深適中，既安全游過礁頂又易與海龜近距離互動。',
        details: '10:30-13:00 浮潛時，水深介於 150cm 至 80cm 之間，既能安全游過珊瑚礁頂不刮傷，水深又剛好方便與海龜近距離互動。'
      },
      {
        time: '13:00',
        title: '午餐外帶：Yusarabi',
      ...
      },
      {
        ...
        notes: '接近 15:38 乾潮，潮間帶與潮池生態大量顯露，極利於步道靜態觀察。',
        details: '此時接近乾潮，內灣水位降低，潮間帶與潮池中的小魚、螃蟹等海洋生物大量顯露在步道兩旁，是進行步道陸上生態觀察的最佳窗口。',
